...
import fotos from "./../Businessfotos.png";
import busPlanner from "./../BusPlanner.png";
import fixerBar from "./../FixerBar.png";
...
const projects = [
  ...
  {
    id: 5,
    name: "wendy-stephan.de",
    imageSrc: fotos,
    href: "https://wendy-stephan.de/businessfotos-preise",
  ...
  },
  {
    ...
    name: "fixerBar",
    imageSrc: fixerBar,
    href: "https://fixerbar.com/",
    used: "WordPress Core, CSS3",
    description: "A photography and film making website",
    flip: "flip-left",
  },
];
